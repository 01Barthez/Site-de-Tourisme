            ...
            <ul className="flex flex-col">
                <li className="w-full relative group">
                    <HoverCard>
                        ...
                        <HoverCardContent className='absolute left-28 bg-card text-card-foreground w-fit min-w-52 px-2 py-6 shadow shadow-foreground/15 border border-foreground/15 rounded'>
